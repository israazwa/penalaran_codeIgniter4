    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-6 col-md-6 col-xl-6">
                <img src="<?= base_url('container/logoPenalaran.png'); ?>" class="img-fluid" alt="" height="480px"
                    width="480px" />
            </div>
            <div class="col-sm-6 col-md-6 col-xl-6">
                <p class="mb-3 mt-5">--Ikhitisar--</p>
                <h3 class="mb-1"><b>PENALARAN</b></h3>
                <p style="text-align: justify;"><?php foreach ($ikhtisar as $y) {
                    echo $y['content'];
                }
                ; ?></p>
                <a href="<?= base_url('/login'); ?>"><button class="tombolRKT h5"><b>About Us!</b></button></a>
                <style>
                    .tombolRKT {
                        background-color: rgb(11, 64, 93);
                        color: white;
