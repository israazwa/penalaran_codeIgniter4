...
<div class="container-fluid">
    <div class="rowC">
        <div class="section">
            <a href=""><img src="<?= base_url('container/logoPenalaran.png'); ?>" alt="Gas Products">
                <div class="caption">RISTEK</div>
            </a>
        </div>
        <div class="section">
            <a href=""><img src="<?= base_url('container/logoPenalaran.png'); ?>" alt="Equipment & Services">
                <div class="caption">PENGMAS</div>
            </a>
        </div>
        <div class="section">
            <a href=""><img src="<?= base_url('container/logoPenalaran.png'); ?>" alt="Sippol & Oxypure">
                <div class="caption">KREATIF</div>
            </a>
        </div>
        <div class="section">
            <a href=""><img src="<?= base_url('container/logoPenalaran.png'); ?>" alt="International Network">
                <div class="caption">KWU</div>
            </a>
        </div>
    </div>
</div>